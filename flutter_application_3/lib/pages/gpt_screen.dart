...
import 'package:flutter_application_3/providers/chat_providers.dart';
import 'package:flutter_application_3/widget/chat_widget.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: Padding(
          ...
          child: Image.asset('images/TERAPI.png'),
        ),
